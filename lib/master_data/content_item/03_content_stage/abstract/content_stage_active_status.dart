...
class ContentStageActiveStatus with ExecutionCore {
  ///
  /// TODO:
  ///
  ContentStageActiveStatus.asDefault() {
    setStatusAsDefault();
  }
  ...
  /// TODO:
  ///
  ContentStageActiveStatus.asActive() {
    setStatusAsActive();
  }
  ...
  ///
  /// TODO: Trạng thái Đã Đóng
  ///
  void setStatusAsClosed() {
    setStatus(value: '[CLOSED]', isPriorityOverride: true);
  }

  bool isStatusAsPerformClosed() {
    if (getStatus == '[CLOSED]') {
      return true;
    }
