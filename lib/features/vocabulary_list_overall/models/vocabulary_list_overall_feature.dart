...
class VocabularyListOverallFeature with ExecutionCore, WindowFeature {
  VocabularyListOverallFeature({required SystemStateManagement? systemStateManagement, required double? sizeDx, required double? sizeDy}) {
          ...
          builder: (context, constraints) {
            return Stack(
              ...
              children: [
                ...
                VocabularyListOverallWidget(
                  vocabularyListOverallFeature: this,
                  onComplete: () {
                    return;
                  },
                ),
