...
class VocabularyListOverallContentWidget extends StatefulWidget {
  const VocabularyListOverallContentWidget({super.key, required this.systemStateManagement, required this.sizeDx, required this.sizeDy});
  ...
  @override
  State<VocabularyListOverallContentWidget> createState() => _VocabularyListOverallContentWidgetState();
}

class _VocabularyListOverallContentWidgetState extends State<VocabularyListOverallContentWidget> with SingleTickerProviderStateMixin {
  Timer? _timer;
      ...
      child: Stack(
        children: [
          ...
          AnimatedPositioned(
            ...
            height: widget.sizeDy - (90.0 + 30.0),
            duration: const Duration(milliseconds: 100),
            child: ClipRRect(
                  ...
                  children: [
                    Positioned(
                      ...
                      child: Stack(
                        ...
                        children: [
                          Positioned(
                            child: TransparentEffectWallWidget(sizeDx: widget.sizeDx, sizeDy: widget.sizeDy - 90.0),
                          ),
                        ],
                      ),
                    ),
