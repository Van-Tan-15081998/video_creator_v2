...
class VocabularyEnglishDefinitionContentWidget extends StatefulWidget {
  const VocabularyEnglishDefinitionContentWidget({super.key, required this.systemStateManagement, required this.sizeDx, required this.sizeDy});
  ...
  @override
  State<VocabularyEnglishDefinitionContentWidget> createState() => _VocabularyEnglishDefinitionContentWidgetState();
}

class _VocabularyEnglishDefinitionContentWidgetState extends State<VocabularyEnglishDefinitionContentWidget> {
