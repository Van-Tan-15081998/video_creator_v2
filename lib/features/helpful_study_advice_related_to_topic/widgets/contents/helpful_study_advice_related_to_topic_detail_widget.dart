...
class HelpfulStudyAdviceRelatedToTopicDetailWidget extends StatefulWidget {
  const HelpfulStudyAdviceRelatedToTopicDetailWidget({super.key, required this.systemStateManagement, required this.sizeDx, required this.sizeDy});
  ...
  @override
  State<HelpfulStudyAdviceRelatedToTopicDetailWidget> createState() => _HelpfulStudyAdviceRelatedToTopicDetailWidgetState();
}

class _HelpfulStudyAdviceRelatedToTopicDetailWidgetState extends State<HelpfulStudyAdviceRelatedToTopicDetailWidget> with SingleTickerProviderStateMixin {
  Timer? _timer;
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      _timer = Timer.periodic(const Duration(seconds: 1), (timer) {
        if (totalSeconds > 0) {
          ...
          totalSeconds = totalSecondsConst;
          widget.systemStateManagement?.getHelpfulStudyAdviceRelatedToTopicFeature?.onDeactivateWindow();
        }
      });
      ...
      children: [
                  ...
                  child: ShaderMask(
                    ...
                    child: Stack(
                      ...
                      children: [
                        ...
                        // ),
                        const HelpfulStudyAdviceRelatedToTopicAnimatedBackgroundWidget(sizeDx: 3500.0, sizeDy: 3500.0),
                      ...
                      children: [
                        TextSpan(
                          text:
                              ...
                              getCurrentVocabularyItem?.getCurrentHelpfulStudyAdviceRelatedToTopic?.getSentenceEng ?? '',
        ...
        AnimatedPositioned(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              // color: Color(0xFF1C1C1C).withValues(alpha: 0.9),
              color: Color(0xFFFFFF00).withValues(alpha: 0.45),
                  ...
                  child: RichText(
                    ...
                    text: TextSpan(
                      ...
                      children: [
                        TextSpan(
                          text:
                              // '"Cô ấy rất tỉ mỉ trong công việc, kiểm tra từng chi tiết hai lần. Cô ấy rất tỉ mỉ trong công việc, kiểm tra từng chi tiết hai lần, kiểm tra từng chi tiết hai lần. Cô ấy rất tỉ mỉ trong công việc, kiểm tra từng chi tiết hai lần."',
                              getCurrentVocabularyItem?.getCurrentHelpfulStudyAdviceRelatedToTopic?.getSentenceVie ?? '',
                          // style: GoogleFonts.sriracha(color: Color(0xFF838B83), fontWeight: FontWeight.w600, fontSize: 40.0, height: 1.5),
        ...
        AnimatedPositioned(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              color: Color(0xFFFFFF00).withValues(alpha: 0.85),
