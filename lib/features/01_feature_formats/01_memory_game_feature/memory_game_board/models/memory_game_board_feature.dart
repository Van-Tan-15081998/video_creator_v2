...
import 'package:frame_creator_v2/features/01_feature_formats/01_memory_game_feature/memory_game_board/widgets/memory_game_board_widget.dart';
...
/// -----
class MemoryGameBoardFeature with ExecutionCore, WindowFeature {
  MemoryGameBoardFeature({required SystemStateManagement? systemStateManagement, required SequentialExecutionController? sequentialExecutionController, required double? sizeDx, required double? sizeDy}) {
  ...
  MemoryTime? get getMemoryTime => _memoryTime;
  void setMemoryTime({required MemoryTime? value, bool? isPriorityOverride}) {
    if (isPriorityOverride == true) {
      _memoryTime = value;
    } else {
      _memoryTime ??= value;
  ...
  Future<void> onSetupRoot({bool? isIgnoreSetupRootForSubCom}) async {
    try {
      ...
      /// -----
      setMemoryTime(
        value: MemoryTime(systemStateManagement: getSystemStateManagement, sequentialExecutionController: getSequentialExecutionController),
        ...
        value: LayoutBuilder(
          builder: (context, constraints) {
            return Stack(
              ...
              children: [MemoryGameBoardWidget(memoryGameBoardFeature: this)],
            );
          },
        ),
        isPriorityOverride: true,
