...
class MemoryGameBoardCharacterWidget extends StatefulWidget {
  const MemoryGameBoardCharacterWidget({super.key, required this.sizeDx, required this.sizeDy});

  final double sizeDx;
  final double sizeDy;

  @override
  State<MemoryGameBoardCharacterWidget> createState() => _MemoryGameBoardCharacterWidgetState();
}

class _MemoryGameBoardCharacterWidgetState extends State<MemoryGameBoardCharacterWidget> {
  @override
  void initState() {
    super.initState();
