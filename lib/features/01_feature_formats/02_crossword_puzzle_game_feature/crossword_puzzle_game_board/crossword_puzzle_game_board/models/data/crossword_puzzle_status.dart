...
class CrosswordPuzzleStatus with ExecutionCore {
  /// -----
  /// TODO:
  /// -----
  String? _status;
  ...
  CrosswordPuzzleStatus.inActive() {
    setStatusInActive();
  }

  CrosswordPuzzleStatus.active() {
    setStatusActive();
  }

  CrosswordPuzzleStatus.complete() {
    setStatusComplete();
  }
  ...
  void setStatusComplete() {
    setStatus(value: '[COMPLETE]', isPriorityOverride: true);
  }
