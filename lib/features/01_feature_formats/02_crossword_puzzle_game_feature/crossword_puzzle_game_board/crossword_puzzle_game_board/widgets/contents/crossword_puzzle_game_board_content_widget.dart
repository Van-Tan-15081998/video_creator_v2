...
import 'package:frame_creator_v2/features/01_feature_formats/02_crossword_puzzle_game_feature/crossword_puzzle_game_board/crossword_puzzle_game_board/widgets/contents/crossword_puzzle_sentence_widget.dart';
import 'package:frame_creator_v2/features/01_feature_formats/02_crossword_puzzle_game_feature/crossword_puzzle_game_board/crossword_puzzle_game_board/widgets/contents/crossword_puzzle_square_board_widget.dart';
...
class CrosswordPuzzleGameBoardContentWidget extends StatefulWidget {
  const CrosswordPuzzleGameBoardContentWidget({super.key, required this.systemStateManagement, required this.sizeDx, required this.sizeDy});
  ...
  @override
  State<CrosswordPuzzleGameBoardContentWidget> createState() => _CrosswordPuzzleGameBoardContentWidgetState();
}

class _CrosswordPuzzleGameBoardContentWidgetState extends State<CrosswordPuzzleGameBoardContentWidget> with TickerProviderStateMixin {
  Timer? _timer;
