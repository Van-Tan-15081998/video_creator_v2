...
class PomodoroEndingConversationContentWidget extends StatefulWidget {
  const PomodoroEndingConversationContentWidget({super.key, required this.systemStateManagement, required this.sizeDx, required this.sizeDy});
  ...
  @override
  State<PomodoroEndingConversationContentWidget> createState() => _PomodoroEndingConversationContentWidgetState();
}

class _PomodoroEndingConversationContentWidgetState extends State<PomodoroEndingConversationContentWidget> {
  Timer? _timer;
