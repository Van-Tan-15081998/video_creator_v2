...
class PomodoroEndingConversationFeature with ExecutionCore, WindowFeature {
  PomodoroEndingConversationFeature({required SystemStateManagement? systemStateManagement, required double? sizeDx, required double? sizeDy}) {
        ...
        value: LayoutBuilder(
          builder: (context, constraints) {
            return Stack(
              ...
              children: [PomodoroEndingConversationWidget(pomodoroEndingConversationFeature: this)],
            );
          },
        ),
