...
class PomodoroStartingConversationFeature with ExecutionCore, WindowFeature {
  PomodoroStartingConversationFeature({required SystemStateManagement? systemStateManagement, required double? sizeDx, required double? sizeDy}) {
        ...
        value: LayoutBuilder(
          builder: (context, constraints) {
            return Stack(
              ...
              children: [PomodoroStartingConversationWidget(pomodoroStartingConversationFeature: this)],
            );
          },
        ),
