...
import 'package:frame_creator_v2/features/conversation/widgets/contents/conversation_character_widget.dart';
import 'package:frame_creator_v2/state_managements/system_state_management.dart';
import 'package:google_fonts/google_fonts.dart';

class ConversationContentWidget extends StatefulWidget {
  const ConversationContentWidget({super.key, required this.systemStateManagement, required this.sizeDx, required this.sizeDy});
  ...
  @override
  State<ConversationContentWidget> createState() => _ConversationContentWidgetState();
}

class _ConversationContentWidgetState extends State<ConversationContentWidget> {
  Timer? _timer;
