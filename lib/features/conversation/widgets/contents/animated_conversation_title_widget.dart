...
class AnimatedConversationTitle extends StatefulWidget {
  const AnimatedConversationTitle({super.key, required this.sizeDx, required this.sizeDy});

  final double sizeDx;
  final double sizeDy;

  @override
  State<AnimatedConversationTitle> createState() => _AnimatedConversationTitleState();
}

class _AnimatedConversationTitleState extends State<AnimatedConversationTitle> with TickerProviderStateMixin {
