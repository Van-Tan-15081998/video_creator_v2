...
class SystemTimelineFeature with ExecutionCore, WindowFeature {
  SystemTimelineFeature({required SystemStateManagement? systemStateManagement, required double? sizeDx, required double? sizeDy}) {
