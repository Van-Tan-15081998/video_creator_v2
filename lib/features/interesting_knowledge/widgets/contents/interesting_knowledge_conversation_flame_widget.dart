...
class InterestingKnowledgeConversationFlameWidget extends FlameGame {
  InterestingKnowledgeConversationFlameWidget({required this.sizeDx, required this.sizeDy});
