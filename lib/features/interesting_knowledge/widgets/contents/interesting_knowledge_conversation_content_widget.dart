...
class InterestingKnowledgeConversationContentWidget extends StatefulWidget {
  const InterestingKnowledgeConversationContentWidget({super.key, required this.systemStateManagement, required this.sizeDx, required this.sizeDy});
  ...
  @override
  State<InterestingKnowledgeConversationContentWidget> createState() => _InterestingKnowledgeConversationContentWidgetState();
}

class _InterestingKnowledgeConversationContentWidgetState extends State<InterestingKnowledgeConversationContentWidget> {
  Timer? _timer;
