...
class AnimatedVocabularyConversationTitleWidget extends StatefulWidget {
  const AnimatedVocabularyConversationTitleWidget({super.key, required this.sizeDx, required this.sizeDy});

  final double sizeDx;
  final double sizeDy;

  @override
  State<AnimatedVocabularyConversationTitleWidget> createState() => _AnimatedVocabularyConversationTitleWidgetState();
}

class _AnimatedVocabularyConversationTitleWidgetState extends State<AnimatedVocabularyConversationTitleWidget> with TickerProviderStateMixin {
