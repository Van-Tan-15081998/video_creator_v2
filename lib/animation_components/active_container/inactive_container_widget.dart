...
class InactiveContainerWidget extends StatefulWidget {
  ...
  @override
  State<InactiveContainerWidget> createState() => _InactiveContainerWidgetState();
}

class _InactiveContainerWidgetState extends State<InactiveContainerWidget> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    _controller = AnimationController(vsync: this, duration: const Duration(seconds: 2000))..repeat(); // Lặp vô hạn
  }
