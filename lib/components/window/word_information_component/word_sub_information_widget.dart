...
class WordSubInformationWidget extends StatefulWidget {
  const WordSubInformationWidget({super.key, required this.sizeDx, required this.sizeDy});

  final double sizeDx;
  final double sizeDy;

  @override
  State<WordSubInformationWidget> createState() => _WordSubInformationWidgetState();
}

class _WordSubInformationWidgetState extends State<WordSubInformationWidget> {
  @override
  void initState() {
    super.initState();
