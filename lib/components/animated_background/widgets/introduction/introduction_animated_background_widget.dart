...
class IntroductionAnimatedBackgroundWidget extends StatefulWidget {
  const IntroductionAnimatedBackgroundWidget({super.key, required this.sizeDx, required this.sizeDy});

  final double sizeDx;
  final double sizeDy;

  @override
  State<IntroductionAnimatedBackgroundWidget> createState() => _IntroductionAnimatedBackgroundWidgetState();
}

class _IntroductionAnimatedBackgroundWidgetState extends State<IntroductionAnimatedBackgroundWidget> {
  @override
  void initState() {
    super.initState();
