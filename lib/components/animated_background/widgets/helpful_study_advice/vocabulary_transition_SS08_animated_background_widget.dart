...
class VocabularyTransitionSs08AnimatedBackgroundWidget extends StatefulWidget {
  const VocabularyTransitionSs08AnimatedBackgroundWidget({super.key, required this.sizeDx, required this.sizeDy});

  final double sizeDx;
  final double sizeDy;

  @override
  State<VocabularyTransitionSs08AnimatedBackgroundWidget> createState() => _VocabularyTransitionSs08AnimatedBackgroundWidgetState();
}

class _VocabularyTransitionSs08AnimatedBackgroundWidgetState extends State<VocabularyTransitionSs08AnimatedBackgroundWidget> {
  // @override
  // void initState() {
  //   super.initState();
  // }
