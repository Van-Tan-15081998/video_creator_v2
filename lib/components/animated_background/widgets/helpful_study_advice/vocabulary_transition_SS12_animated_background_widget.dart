...
class VocabularyTransitionSs12AnimatedBackgroundWidget extends StatefulWidget {
  const VocabularyTransitionSs12AnimatedBackgroundWidget({super.key, required this.sizeDx, required this.sizeDy});

  final double sizeDx;
  final double sizeDy;

  @override
  State<VocabularyTransitionSs12AnimatedBackgroundWidget> createState() => _VocabularyTransitionSs12AnimatedBackgroundWidgetState();
}

class _VocabularyTransitionSs12AnimatedBackgroundWidgetState extends State<VocabularyTransitionSs12AnimatedBackgroundWidget> {
