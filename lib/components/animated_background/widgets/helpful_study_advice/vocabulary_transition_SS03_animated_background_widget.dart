...
class VocabularyTransitionSs03AnimatedBackgroundWidget extends StatefulWidget {
  const VocabularyTransitionSs03AnimatedBackgroundWidget({super.key, required this.sizeDx, required this.sizeDy});

  final double sizeDx;
  final double sizeDy;

  @override
  State<VocabularyTransitionSs03AnimatedBackgroundWidget> createState() => _VocabularyTransitionSs03AnimatedBackgroundWidgetState();
}

class _VocabularyTransitionSs03AnimatedBackgroundWidgetState extends State<VocabularyTransitionSs03AnimatedBackgroundWidget> {
  // @override
  // void initState() {
  //   super.initState();
  // }
