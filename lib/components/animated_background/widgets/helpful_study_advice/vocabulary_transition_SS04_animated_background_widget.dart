...
class VocabularyTransitionSs04AnimatedBackgroundWidget extends StatefulWidget {
  const VocabularyTransitionSs04AnimatedBackgroundWidget({super.key, required this.sizeDx, required this.sizeDy});

  final double sizeDx;
  final double sizeDy;

  @override
  State<VocabularyTransitionSs04AnimatedBackgroundWidget> createState() => _VocabularyTransitionSs04AnimatedBackgroundWidgetState();
}

class _VocabularyTransitionSs04AnimatedBackgroundWidgetState extends State<VocabularyTransitionSs04AnimatedBackgroundWidget> {
  // @override
  // void initState() {
  //   super.initState();
  // }
