...
class VocabularyTransitionSs11AnimatedBackgroundWidget extends StatefulWidget {
  const VocabularyTransitionSs11AnimatedBackgroundWidget({super.key, required this.sizeDx, required this.sizeDy});

  final double sizeDx;
  final double sizeDy;

  @override
  State<VocabularyTransitionSs11AnimatedBackgroundWidget> createState() => _VocabularyTransitionSs11AnimatedBackgroundWidgetState();
}

class _VocabularyTransitionSs11AnimatedBackgroundWidgetState extends State<VocabularyTransitionSs11AnimatedBackgroundWidget> {
