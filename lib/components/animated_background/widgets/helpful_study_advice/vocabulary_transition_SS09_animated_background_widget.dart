...
class VocabularyTransitionSs09AnimatedBackgroundWidget extends StatefulWidget {
  const VocabularyTransitionSs09AnimatedBackgroundWidget({super.key, required this.sizeDx, required this.sizeDy});

  final double sizeDx;
  final double sizeDy;

  @override
  State<VocabularyTransitionSs09AnimatedBackgroundWidget> createState() => _VocabularyTransitionSs09AnimatedBackgroundWidgetState();
}

class _VocabularyTransitionSs09AnimatedBackgroundWidgetState extends State<VocabularyTransitionSs09AnimatedBackgroundWidget> {
  // @override
  // void initState() {
  //   super.initState();
  // }
