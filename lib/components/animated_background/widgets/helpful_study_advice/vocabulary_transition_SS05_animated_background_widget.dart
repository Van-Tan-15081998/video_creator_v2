...
class VocabularyTransitionSs05AnimatedBackgroundWidget extends StatefulWidget {
  const VocabularyTransitionSs05AnimatedBackgroundWidget({super.key, required this.sizeDx, required this.sizeDy});

  final double sizeDx;
  final double sizeDy;

  @override
  State<VocabularyTransitionSs05AnimatedBackgroundWidget> createState() => _VocabularyTransitionSs05AnimatedBackgroundWidgetState();
}

class _VocabularyTransitionSs05AnimatedBackgroundWidgetState extends State<VocabularyTransitionSs05AnimatedBackgroundWidget> {
  // @override
  // void initState() {
  //   super.initState();
  // }
