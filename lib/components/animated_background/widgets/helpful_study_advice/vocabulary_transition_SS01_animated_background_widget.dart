...
class VocabularyTransitionSs01AnimatedBackgroundWidget extends StatefulWidget {
  const VocabularyTransitionSs01AnimatedBackgroundWidget({super.key, required this.sizeDx, required this.sizeDy});

  final double sizeDx;
  final double sizeDy;

  @override
  State<VocabularyTransitionSs01AnimatedBackgroundWidget> createState() => _VocabularyTransitionSs01AnimatedBackgroundWidgetState();
}

class _VocabularyTransitionSs01AnimatedBackgroundWidgetState extends State<VocabularyTransitionSs01AnimatedBackgroundWidget> {
  // @override
  // void initState() {
  //   super.initState();
  // }
