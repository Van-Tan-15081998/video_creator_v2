...
class VocabularyTransitionSs07AnimatedBackgroundWidget extends StatefulWidget {
  const VocabularyTransitionSs07AnimatedBackgroundWidget({super.key, required this.sizeDx, required this.sizeDy});

  final double sizeDx;
  final double sizeDy;

  @override
  State<VocabularyTransitionSs07AnimatedBackgroundWidget> createState() => _VocabularyTransitionSs07AnimatedBackgroundWidgetState();
}

class _VocabularyTransitionSs07AnimatedBackgroundWidgetState extends State<VocabularyTransitionSs07AnimatedBackgroundWidget> {
  // @override
  // void initState() {
  //   super.initState();
  // }
