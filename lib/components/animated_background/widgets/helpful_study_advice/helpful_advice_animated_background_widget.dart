...
class HelpfulAdviceAnimatedBackgroundWidget extends StatefulWidget {
  const HelpfulAdviceAnimatedBackgroundWidget({super.key, required this.sizeDx, required this.sizeDy});

  final double sizeDx;
  final double sizeDy;

  @override
  State<HelpfulAdviceAnimatedBackgroundWidget> createState() => _HelpfulAdviceAnimatedBackgroundWidgetState();
}

class _HelpfulAdviceAnimatedBackgroundWidgetState extends State<HelpfulAdviceAnimatedBackgroundWidget> {
  @override
  void initState() {
    super.initState();
  }
