...
class VocabularyTransitionSs13AnimatedBackgroundWidget extends StatefulWidget {
  const VocabularyTransitionSs13AnimatedBackgroundWidget({super.key, required this.sizeDx, required this.sizeDy});

  final double sizeDx;
  final double sizeDy;

  @override
  State<VocabularyTransitionSs13AnimatedBackgroundWidget> createState() => _VocabularyTransitionSs13AnimatedBackgroundWidgetState();
}

class _VocabularyTransitionSs13AnimatedBackgroundWidgetState extends State<VocabularyTransitionSs13AnimatedBackgroundWidget> {
  @override
  void initState() {
    super.initState();
