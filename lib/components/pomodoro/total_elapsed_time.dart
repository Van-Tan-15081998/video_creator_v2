  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      _timer = Timer.periodic(const Duration(milliseconds: 10), (timer) {
        secondsString = widget.systemStateManagement?.getMainTimelineStateManagement?.getTimeline?.getTimeUnitString(isSecond: true) ?? "00";
        minutesString = widget.systemStateManagement?.getMainTimelineStateManagement?.getTimeline?.getTimeUnitString(isMinute: true) ?? "00";
        hoursString = widget.systemStateManagement?.getMainTimelineStateManagement?.getTimeline?.getTimeUnitString(isHour: true) ?? "00";
