...
class AnimatedTopicTitle extends StatefulWidget {
  const AnimatedTopicTitle({super.key, required this.sizeDx, required this.sizeDy});

  final double sizeDx;
  final double sizeDy;

  @override
  State<AnimatedTopicTitle> createState() => _AnimatedTopicTitleState();
}

class _AnimatedTopicTitleState extends State<AnimatedTopicTitle> with TickerProviderStateMixin {
