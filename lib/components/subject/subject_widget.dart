...
class SubjectWidget extends StatefulWidget {
  const SubjectWidget({super.key, required this.sizeDx, required this.sizeDy});
...
class _SubjectWidgetState extends State<SubjectWidget> with SingleTickerProviderStateMixin {
    ...
    return Stack(
      ...
      children: [
        AnimatedPositioned(
          ...
          width: 300.0,
          height: 300.0,
          child: AnimatedTopicTitle(sizeDx: 300.0, sizeDy: 300.0), //
        ),
        ...
        AnimatedPositioned(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              // color: Color(0xFF00BFFF).withValues(alpha: 1.0),
  ...
  Widget topicTitle({required String word}) {
    ...
    //     textStyle: TextStyle(fontSize: 40.0, fontWeight: FontWeight.bold, fontStyle: FontStyle.normal, color: Color(0xFFECECEC).withValues(alpha: 1), letterSpacing: 10.0),
    //   ),
    //   textAlign: TextAlign.start,
    //   overflow: TextOverflow.ellipsis,
    //   maxLines: 1,
