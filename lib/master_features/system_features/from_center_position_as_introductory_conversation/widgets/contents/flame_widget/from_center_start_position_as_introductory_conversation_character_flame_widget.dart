...
class FromCenterStartPositionAsIntroductoryConversationCharacterFlameWidget extends FlameGame {
  FromCenterStartPositionAsIntroductoryConversationCharacterFlameWidget({required this.sizeDx, required this.sizeDy});
