...
class FromCenterPositionAsIntroductoryConversationContentWidget extends StatefulWidget {
  const FromCenterPositionAsIntroductoryConversationContentWidget({super.key, required this.systemStateManagement, required this.sizeDx, required this.sizeDy});
