...
import 'package:frame_creator_v2/master_features/system_features/from_bottom_end_position_as_pomodoro_cycle/widgets/contents/from_bottom_end_position_as_pomodoro_cycle_total_elapsed_time_widget.dart';
import 'package:frame_creator_v2/state_managements/system_state_management.dart';
import 'package:google_fonts/google_fonts.dart';

class FromBottomEndPositionAsPomodoroCycleContentWidget extends StatefulWidget {
  const FromBottomEndPositionAsPomodoroCycleContentWidget({super.key, required this.systemStateManagement, required this.sizeDx, required this.sizeDy});
  ...
  @override
  State<FromBottomEndPositionAsPomodoroCycleContentWidget> createState() => _FromBottomEndPositionAsPomodoroCycleContentWidgetState();
}

class _FromBottomEndPositionAsPomodoroCycleContentWidgetState extends State<FromBottomEndPositionAsPomodoroCycleContentWidget> {
  Timer? _timer;
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      _timer = Timer.periodic(const Duration(milliseconds: 10), (timer) {
        if (widget.systemStateManagement?.getSystemFeatureManagement?.getFromBottomEndPositionAsPomodoroCycleSystemFeature?.checkConditionActiveByDirection() == true) {
          ///
          /// TODO: StayFocused
          ///
          ...
          if (widget.systemStateManagement?.getSystemFeatureManagement?.getFromBottomEndPositionAsPomodoroCycleSystemFeature?.getPomodoroCycleTimer?.getStayFocusedSS01?.getPomodoroContentStage?.getActiveStatus?.isStatusAsActive() == true) {
            stayFocusedProgressbarPomodoroSS01 = stayFocusedProgressbar * ((widget.systemStateManagement?.getSystemFeatureManagement?.getFromBottomEndPositionAsPomodoroCycleSystemFeature?.getPomodoroCycleTimer?.getStayFocusedSS01?.getPercentComplete ?? 0) / 100);
          ...
          if (widget.systemStateManagement?.getSystemFeatureManagement?.getFromBottomEndPositionAsPomodoroCycleSystemFeature?.getPomodoroCycleTimer?.getStayFocusedSS02?.getPomodoroContentStage?.getActiveStatus?.isStatusAsActive() == true) {
            stayFocusedProgressbarPomodoroSS02 = stayFocusedProgressbar * ((widget.systemStateManagement?.getSystemFeatureManagement?.getFromBottomEndPositionAsPomodoroCycleSystemFeature?.getPomodoroCycleTimer?.getStayFocusedSS02?.getPercentComplete ?? 0) / 100);
          ...
          if (widget.systemStateManagement?.getSystemFeatureManagement?.getFromBottomEndPositionAsPomodoroCycleSystemFeature?.getPomodoroCycleTimer?.getStayFocusedSS03?.getPomodoroContentStage?.getActiveStatus?.isStatusAsActive() == true) {
            stayFocusedProgressbarPomodoroSS03 = stayFocusedProgressbar * ((widget.systemStateManagement?.getSystemFeatureManagement?.getFromBottomEndPositionAsPomodoroCycleSystemFeature?.getPomodoroCycleTimer?.getStayFocusedSS03?.getPercentComplete ?? 0) / 100);
          ...
          if (widget.systemStateManagement?.getSystemFeatureManagement?.getFromBottomEndPositionAsPomodoroCycleSystemFeature?.getPomodoroCycleTimer?.getStayFocusedSS04?.getPomodoroContentStage?.getActiveStatus?.isStatusAsActive() == true) {
            stayFocusedProgressbarPomodoroSS04 = stayFocusedProgressbar * ((widget.systemStateManagement?.getSystemFeatureManagement?.getFromBottomEndPositionAsPomodoroCycleSystemFeature?.getPomodoroCycleTimer?.getStayFocusedSS04?.getPercentComplete ?? 0) / 100);
          ...
          if (widget.systemStateManagement?.getSystemFeatureManagement?.getFromBottomEndPositionAsPomodoroCycleSystemFeature?.getPomodoroCycleTimer?.getBreakTimeSS01?.getPomodoroContentStage?.getActiveStatus?.isStatusAsActive() == true) {
            breakTimeProgressbarPomodoroSS01 = breakTimeProgressbar * ((widget.systemStateManagement?.getSystemFeatureManagement?.getFromBottomEndPositionAsPomodoroCycleSystemFeature?.getPomodoroCycleTimer?.getBreakTimeSS01?.getPercentComplete ?? 0) / 100);
          ...
          if (widget.systemStateManagement?.getSystemFeatureManagement?.getFromBottomEndPositionAsPomodoroCycleSystemFeature?.getPomodoroCycleTimer?.getBreakTimeSS02?.getPomodoroContentStage?.getActiveStatus?.isStatusAsActive() == true) {
            breakTimeProgressbarPomodoroSS02 = breakTimeProgressbar * ((widget.systemStateManagement?.getSystemFeatureManagement?.getFromBottomEndPositionAsPomodoroCycleSystemFeature?.getPomodoroCycleTimer?.getBreakTimeSS02?.getPercentComplete ?? 0) / 100);
          ...
          if (widget.systemStateManagement?.getSystemFeatureManagement?.getFromBottomEndPositionAsPomodoroCycleSystemFeature?.getPomodoroCycleTimer?.getBreakTimeSS03?.getPomodoroContentStage?.getActiveStatus?.isStatusAsActive() == true) {
            breakTimeProgressbarPomodoroSS03 = breakTimeProgressbar * ((widget.systemStateManagement?.getSystemFeatureManagement?.getFromBottomEndPositionAsPomodoroCycleSystemFeature?.getPomodoroCycleTimer?.getBreakTimeSS03?.getPercentComplete ?? 0) / 100);
          ...
          if (widget.systemStateManagement?.getSystemFeatureManagement?.getFromBottomEndPositionAsPomodoroCycleSystemFeature?.getPomodoroCycleTimer?.getBreakTimeSS04?.getPomodoroContentStage?.getActiveStatus?.isStatusAsActive() == true) {
            breakTimeProgressbarPomodoroSS04 = breakTimeProgressbar * ((widget.systemStateManagement?.getSystemFeatureManagement?.getFromBottomEndPositionAsPomodoroCycleSystemFeature?.getPomodoroCycleTimer?.getBreakTimeSS04?.getPercentComplete ?? 0) / 100);
      ...
      case '[PomodoroSS01]':
        {
          ...
          if (widget.systemStateManagement?.getSystemFeatureManagement?.getFromBottomEndPositionAsPomodoroCycleSystemFeature?.getPomodoroCycleTimer?.getStayFocusedSS01?.getPercentComplete != 100) {
            isProcessingStayFocused = true;
          }
          if (widget.systemStateManagement?.getSystemFeatureManagement?.getFromBottomEndPositionAsPomodoroCycleSystemFeature?.getPomodoroCycleTimer?.getBreakTimeSS01?.getPercentComplete != 100) {
      ...
      case '[PomodoroSS02]':
        {
          ...
          if (widget.systemStateManagement?.getSystemFeatureManagement?.getFromBottomEndPositionAsPomodoroCycleSystemFeature?.getPomodoroCycleTimer?.getStayFocusedSS02?.getPercentComplete != 100) {
            isProcessingStayFocused = true;
          }
          if (widget.systemStateManagement?.getSystemFeatureManagement?.getFromBottomEndPositionAsPomodoroCycleSystemFeature?.getPomodoroCycleTimer?.getBreakTimeSS02?.getPercentComplete != 100) {
            isProcessingBreakTime = true;
          }
      ...
      case '[PomodoroSS03]':
        {
          ...
          if (widget.systemStateManagement?.getSystemFeatureManagement?.getFromBottomEndPositionAsPomodoroCycleSystemFeature?.getPomodoroCycleTimer?.getStayFocusedSS03?.getPercentComplete != 100) {
            isProcessingStayFocused = true;
          }
          if (widget.systemStateManagement?.getSystemFeatureManagement?.getFromBottomEndPositionAsPomodoroCycleSystemFeature?.getPomodoroCycleTimer?.getBreakTimeSS03?.getPercentComplete != 100) {
            isProcessingBreakTime = true;
          }
      ...
      case '[PomodoroSS04]':
        {
          ...
          if (widget.systemStateManagement?.getSystemFeatureManagement?.getFromBottomEndPositionAsPomodoroCycleSystemFeature?.getPomodoroCycleTimer?.getStayFocusedSS04?.getPercentComplete != 100) {
            isProcessingStayFocused = true;
          }
          if (widget.systemStateManagement?.getSystemFeatureManagement?.getFromBottomEndPositionAsPomodoroCycleSystemFeature?.getPomodoroCycleTimer?.getBreakTimeSS04?.getPercentComplete != 100) {
            isProcessingBreakTime = true;
          }
      ...
      child: Stack(
        children: [
          ...
          AnimatedPositioned(
            ...
            child: FromBottomEndPositionAsPomodoroCycleTotalElapsedTimeWidget(systemStateManagement: widget.systemStateManagement, sizeDx: widget.sizeDx - 20.0, sizeDy: widget.sizeDy * 0.15),
          ),
        ],
      ),
    );
