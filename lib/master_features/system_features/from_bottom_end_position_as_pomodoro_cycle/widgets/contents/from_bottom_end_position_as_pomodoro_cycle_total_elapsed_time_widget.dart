...
class FromBottomEndPositionAsPomodoroCycleTotalElapsedTimeWidget extends StatefulWidget {
  const FromBottomEndPositionAsPomodoroCycleTotalElapsedTimeWidget({super.key, required this.systemStateManagement, required this.sizeDx, required this.sizeDy});
  ...
  @override
  State<FromBottomEndPositionAsPomodoroCycleTotalElapsedTimeWidget> createState() => _FromBottomEndPositionAsPomodoroCycleTotalElapsedTimeWidgetState();
}

class _FromBottomEndPositionAsPomodoroCycleTotalElapsedTimeWidgetState extends State<FromBottomEndPositionAsPomodoroCycleTotalElapsedTimeWidget> {
  Timer? _timer;
