...
class FromCenterStartPositionAsPomodoroComingUpContentWidget extends StatefulWidget {
  const FromCenterStartPositionAsPomodoroComingUpContentWidget({super.key, required this.systemStateManagement, required this.sizeDx, required this.sizeDy});
  ...
  @override
  State<FromCenterStartPositionAsPomodoroComingUpContentWidget> createState() => _FromCenterStartPositionAsPomodoroComingUpContentWidgetState();
}

class _FromCenterStartPositionAsPomodoroComingUpContentWidgetState extends State<FromCenterStartPositionAsPomodoroComingUpContentWidget> with SingleTickerProviderStateMixin, CharacterMixin, WindowMixin {
