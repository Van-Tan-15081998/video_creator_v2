...
class FromCenterStartPositionAsPomodoroComingUpCharacterFlameWidget extends FlameGame with PositionedCharacterMixin {
  FromCenterStartPositionAsPomodoroComingUpCharacterFlameWidget({required this.sizeDx, required this.sizeDy, required this.coreFeature});
