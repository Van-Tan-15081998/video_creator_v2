...
class FromCenterStartPositionAsPomodoroComingUpCharacterFlameWidget extends FlameGame {
  FromCenterStartPositionAsPomodoroComingUpCharacterFlameWidget({required this.sizeDx, required this.sizeDy});
