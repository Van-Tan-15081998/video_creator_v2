...
class CrosswordPuzzlePieceStateItem {
  /// -----
  /// TODO:
  /// -----
  CrosswordPuzzlePiece? _stateModel;
  CrosswordPuzzlePiece? get getStateModel => _stateModel;
  void setStateModel({required CrosswordPuzzlePiece? value, bool? isPriorityOverride}) {
  ...
  /// TODO:
  /// -----
  CrosswordPuzzlePieceStateItem({required CrosswordPuzzlePiece? stateModel}) {
