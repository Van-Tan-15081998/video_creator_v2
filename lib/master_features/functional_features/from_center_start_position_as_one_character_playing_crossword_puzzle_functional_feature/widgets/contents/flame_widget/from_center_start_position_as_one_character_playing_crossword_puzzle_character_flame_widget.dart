...
class FromCenterStartPositionAsOneCharacterPlayingCrosswordPuzzleCharacterFlameWidget extends FlameGame with PositionedCharacterMixin {
  FromCenterStartPositionAsOneCharacterPlayingCrosswordPuzzleCharacterFlameWidget({required this.sizeDx, required this.sizeDy, required this.coreFeature});
