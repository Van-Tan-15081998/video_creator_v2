...
class FromCenterStartPositionAsOneCharacterPlayingCrosswordPuzzleCharacterWidget extends StatefulWidget {
  const FromCenterStartPositionAsOneCharacterPlayingCrosswordPuzzleCharacterWidget({super.key, required this.sizeDx, required this.sizeDy});
      ...
      child: Stack(
        ...
        children: [
          Positioned(
            ...
            height: widget.sizeDy,
            child: GameWidget(
              game: FromCenterStartPositionAsOneCharacterPlayingCrosswordPuzzleCharacterFlameWidget(sizeDx: widget.sizeDx, sizeDy: widget.sizeDy),
            ),
          ),
        ],
      ),
