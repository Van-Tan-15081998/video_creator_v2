...
class FromCenterPositionAsTheIntroductorySectionPomodoroSs01CharacterFlameWidget extends FlameGame with PositionedCharacterMixin {
  FromCenterPositionAsTheIntroductorySectionPomodoroSs01CharacterFlameWidget({required this.sizeDx, required this.sizeDy, required this.coreFeature});
  ...
  Future<void> onLoad() async {
    ...
    final imageSS02 = await images.load('sprite_sheet/07B/monster07B.png');
