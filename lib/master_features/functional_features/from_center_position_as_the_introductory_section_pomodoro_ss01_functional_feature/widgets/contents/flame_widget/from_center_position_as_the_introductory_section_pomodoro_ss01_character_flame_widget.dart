...
class FromCenterPositionAsTheIntroductorySectionPomodoroSs01CharacterFlameWidget extends FlameGame {
  FromCenterPositionAsTheIntroductorySectionPomodoroSs01CharacterFlameWidget({required this.sizeDx, required this.sizeDy});
