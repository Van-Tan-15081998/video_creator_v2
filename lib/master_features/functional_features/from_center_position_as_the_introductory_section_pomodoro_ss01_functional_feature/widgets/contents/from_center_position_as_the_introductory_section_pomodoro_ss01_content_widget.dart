...
class FromCenterPositionAsTheIntroductorySectionPomodoroSS01ContentWidget extends StatefulWidget {
  const FromCenterPositionAsTheIntroductorySectionPomodoroSS01ContentWidget({super.key, required this.systemStateManagement, required this.sizeDx, required this.sizeDy});
  ...
  @override
  State<FromCenterPositionAsTheIntroductorySectionPomodoroSS01ContentWidget> createState() => _FromCenterPositionAsTheIntroductorySectionPomodoroSS01ContentWidgetState();
}

class _FromCenterPositionAsTheIntroductorySectionPomodoroSS01ContentWidgetState extends State<FromCenterPositionAsTheIntroductorySectionPomodoroSS01ContentWidget> with SingleTickerProviderStateMixin, CharacterMixin, WindowMixin {
  ...
  void initState() {
    ...
    /// -----
    setWindowId(value: SystemWindow.fromCenterPositionAsTheIntroductorySectionPomodoroSS01Window, isPriorityOverride: true);
