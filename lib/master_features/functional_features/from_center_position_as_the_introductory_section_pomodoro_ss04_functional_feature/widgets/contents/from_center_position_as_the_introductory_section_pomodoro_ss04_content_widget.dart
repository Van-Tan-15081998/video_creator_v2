...
class FromCenterPositionAsTheIntroductorySectionPomodoroSS04ContentWidget extends StatefulWidget {
  const FromCenterPositionAsTheIntroductorySectionPomodoroSS04ContentWidget({super.key, required this.systemStateManagement, required this.sizeDx, required this.sizeDy});
  ...
  @override
  State<FromCenterPositionAsTheIntroductorySectionPomodoroSS04ContentWidget> createState() => _FromCenterPositionAsTheIntroductorySectionPomodoroSS04ContentWidgetState();
}

class _FromCenterPositionAsTheIntroductorySectionPomodoroSS04ContentWidgetState extends State<FromCenterPositionAsTheIntroductorySectionPomodoroSS04ContentWidget> with SingleTickerProviderStateMixin, CharacterMixin, WindowMixin {
  ...
  void initState() {
    ...
    /// -----
    setWindowId(value: SystemWindow.fromCenterPositionAsTheIntroductorySectionPomodoroSS04Window, isPriorityOverride: true);
