...
class FromCenterStartPositionAsOneCharacterConversationFunctionalFeature extends CoreFeature with ExecutionCore, WindowFeature {
  FromCenterStartPositionAsOneCharacterConversationFunctionalFeature({required SystemStateManagement? systemStateManagement, required double? sizeDx, required double? sizeDy}) {
        ...
        value: LayoutBuilder(
          builder: (context, constraints) {
            return Stack(
              ...
              children: [FromCenterStartPositionAsOneCharacterConversationWidget(fromCenterStartPositionAsOneCharacterConversationFunctionalFeature: this)],
            );
          },
        ),
