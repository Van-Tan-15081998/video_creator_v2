...
class FromCenterStartPositionAsOneCharacterConversationCharacterFlameWidget extends FlameGame with PositionedCharacterMixin {
  FromCenterStartPositionAsOneCharacterConversationCharacterFlameWidget({required this.sizeDx, required this.sizeDy, required this.coreFeature});
