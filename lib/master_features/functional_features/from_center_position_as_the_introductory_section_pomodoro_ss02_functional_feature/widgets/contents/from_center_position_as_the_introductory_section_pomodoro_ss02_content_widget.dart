...
class FromCenterPositionAsTheIntroductorySectionPomodoroSS02ContentWidget extends StatefulWidget {
  const FromCenterPositionAsTheIntroductorySectionPomodoroSS02ContentWidget({super.key, required this.systemStateManagement, required this.sizeDx, required this.sizeDy});
  ...
  @override
  State<FromCenterPositionAsTheIntroductorySectionPomodoroSS02ContentWidget> createState() => _FromCenterPositionAsTheIntroductorySectionPomodoroSS02ContentWidgetState();
}

class _FromCenterPositionAsTheIntroductorySectionPomodoroSS02ContentWidgetState extends State<FromCenterPositionAsTheIntroductorySectionPomodoroSS02ContentWidget> with SingleTickerProviderStateMixin, CharacterMixin, WindowMixin {
  ...
  void initState() {
    ...
    /// -----
    setWindowId(value: SystemWindow.fromCenterPositionAsTheIntroductorySectionPomodoroSS02Window, isPriorityOverride: true);
          ...
          AnimatedPositioned(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                borderRadius: BorderRadius.only(topLeft: Radius.circular(0), topRight: Radius.circular(30.0), bottomRight: Radius.circular(0), bottomLeft: Radius.circular(15.0)),
              ),
