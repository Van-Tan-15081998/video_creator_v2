...
class FromTopEndPositionAsOneCharacterConversationContentWidget extends StatefulWidget {
  const FromTopEndPositionAsOneCharacterConversationContentWidget({super.key, required this.systemStateManagement, required this.sizeDx, required this.sizeDy});
  ...
  @override
  State<FromTopEndPositionAsOneCharacterConversationContentWidget> createState() => _FromTopEndPositionAsOneCharacterConversationContentWidgetState();
}

class _FromTopEndPositionAsOneCharacterConversationContentWidgetState extends State<FromTopEndPositionAsOneCharacterConversationContentWidget> with SingleTickerProviderStateMixin, CharacterMixin, WindowMixin {
