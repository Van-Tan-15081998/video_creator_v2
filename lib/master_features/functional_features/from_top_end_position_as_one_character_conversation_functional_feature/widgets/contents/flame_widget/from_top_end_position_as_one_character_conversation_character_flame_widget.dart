...
class FromTopEndPositionAsOneCharacterConversationCharacterFlameWidget extends FlameGame with PositionedCharacterMixin {
  FromTopEndPositionAsOneCharacterConversationCharacterFlameWidget({required this.sizeDx, required this.sizeDy, required this.coreFeature});
