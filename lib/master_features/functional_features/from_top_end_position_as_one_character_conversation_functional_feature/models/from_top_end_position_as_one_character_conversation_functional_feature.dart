...
class FromTopEndPositionAsOneCharacterConversationFunctionalFeature extends CoreFeature with ExecutionCore, WindowFeature {
  FromTopEndPositionAsOneCharacterConversationFunctionalFeature({required SystemStateManagement? systemStateManagement, required double? sizeDx, required double? sizeDy}) {
        ...
        value: LayoutBuilder(
          builder: (context, constraints) {
            return Stack(
              ...
              children: [FromTopEndPositionAsOneCharacterConversationWidget(fromTopEndPositionAsOneCharacterConversationFunctionalFeature: this)],
            );
          },
        ),
