...
class FromCenterStartPositionAsTwoCharacterPlayingChessContentWidget extends StatefulWidget {
  const FromCenterStartPositionAsTwoCharacterPlayingChessContentWidget({super.key, required this.systemStateManagement, required this.sizeDx, required this.sizeDy});
  ...
  @override
  State<FromCenterStartPositionAsTwoCharacterPlayingChessContentWidget> createState() => _FromCenterStartPositionAsTwoCharacterPlayingChessContentWidgetState();
}

class _FromCenterStartPositionAsTwoCharacterPlayingChessContentWidgetState extends State<FromCenterStartPositionAsTwoCharacterPlayingChessContentWidget> with SingleTickerProviderStateMixin, CharacterMixin, WindowMixin {
