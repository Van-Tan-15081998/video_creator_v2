...
class _ChessSquareWidgetState extends State<ChessSquareWidget> with TickerProviderStateMixin {
  ...
  bool isActiveDefaultBackgroundColor() {
    if (getIsHighlightOriginByChessPiece == true || //
        ...
        getIsHighlightCheckmateByChessPiece ==
            true //
            ) {
      return false;
    }
  ...
  Widget build(BuildContext context) {
    return ClipRRect(
      ...
      child: Stack(
        alignment: AlignmentDirectional.center,
        children: [
          isActiveDefaultBackgroundColor()
              ? Positioned(
                  width: widget.sizeDx,
          ...
          getIsHighlightOriginByChessPiece == true
              ? Positioned(
                  ...
                  child: AnimatedContainer(
                    ...
                    width: widget.sizeDx,
                    height: widget.sizeDy,
                    decoration: BoxDecoration(color: Color(0xFFFFFF00).withValues(alpha: 0.9)),
                  ),
                )
              : Container(),
          ...
          getIsHighlightDestinationByChessPiece == true
              ? Positioned(
                  ...
                  child: AnimatedContainer(
                    ...
                    width: widget.sizeDx,
                    height: widget.sizeDy,
                    decoration: BoxDecoration(color: Color(0xFFFFD700).withValues(alpha: 0.9)),
                  ),
                )
              : Container(),
          ...
          getIsHighlightSpecifyDisplayByChessPiece == true
              ? Positioned(
                  ...
                  child: AnimatedContainer(
                    ...
                    width: widget.sizeDx,
                    height: widget.sizeDy,
                    decoration: BoxDecoration(color: Color(0xFF00BFFF).withValues(alpha: 0.9)),
                  ),
                )
              : Container(),
          ...
          getIsHighlightCanCaptureByChessPiece == true
              ? Positioned(
                  ...
                  child: AnimatedContainer(
                    ...
                    height: 90.0,
                    decoration: BoxDecoration(
                      color: Color(0xFFFF4040).withValues(alpha: 0.9),
          ...
          getIsHighlightCheckmateByChessPiece == true
              ? Positioned(
                  ...
                  child: AnimatedContainer(
                    ...
                    width: widget.sizeDx,
                    height: widget.sizeDy,
                    decoration: BoxDecoration(color: Color(0xFFFF4040).withValues(alpha: 0.9)),
                  ),
                )
              : Container(),
