...
class FromCenterPositionAsTheIntroductorySectionPomodoroSS03CharacterFlameWidget extends FlameGame with PositionedCharacterMixin {
  FromCenterPositionAsTheIntroductorySectionPomodoroSS03CharacterFlameWidget({required this.sizeDx, required this.sizeDy, required this.coreFeature});
