...
class FromCenterStartPositionAsTwoCharacterConversationCharacterFlameWidget extends FlameGame {
  FromCenterStartPositionAsTwoCharacterConversationCharacterFlameWidget({required this.sizeDx, required this.sizeDy});
