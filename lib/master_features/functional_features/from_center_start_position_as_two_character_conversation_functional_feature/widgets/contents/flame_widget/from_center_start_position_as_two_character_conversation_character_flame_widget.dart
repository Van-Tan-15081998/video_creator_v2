...
class FromCenterStartPositionAsTwoCharacterConversationCharacterFlameWidget extends FlameGame with PositionedCharacterMixin {
  FromCenterStartPositionAsTwoCharacterConversationCharacterFlameWidget({required this.sizeDx, required this.sizeDy, required this.coreFeature});
