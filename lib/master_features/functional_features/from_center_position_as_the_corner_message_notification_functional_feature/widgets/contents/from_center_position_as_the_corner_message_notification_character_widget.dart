...
class FromCenterPositionAsTheCornerMessageNotificationCharacterWidget extends StatefulWidget {
  const FromCenterPositionAsTheCornerMessageNotificationCharacterWidget({super.key, required this.sizeDx, required this.sizeDy, required this.coreFeature});
      ...
      child: Stack(
        ...
        children: [
          Positioned(
            ...
            height: widget.sizeDy,
            child: GameWidget(
              game: FromCenterPositionAsTheCornerMessageNotificationCharacterFlameWidget(sizeDx: widget.sizeDx, sizeDy: widget.sizeDy, coreFeature: widget.coreFeature),
            ),
          ),
        ],
      ),
