...
class FromCenterPositionAsTheCornerMessageNotificationCharacterFlameWidget extends FlameGame with PositionedCharacterMixin {
  FromCenterPositionAsTheCornerMessageNotificationCharacterFlameWidget({required this.sizeDx, required this.sizeDy, required this.coreFeature});
