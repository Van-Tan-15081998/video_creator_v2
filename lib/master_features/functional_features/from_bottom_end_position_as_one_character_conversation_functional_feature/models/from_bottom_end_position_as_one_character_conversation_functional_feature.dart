...
class FromBottomEndPositionAsOneCharacterConversationFunctionalFeature extends CoreFeature with ExecutionCore, WindowFeature {
  FromBottomEndPositionAsOneCharacterConversationFunctionalFeature({required SystemStateManagement? systemStateManagement, required double? sizeDx, required double? sizeDy}) {
        ...
        value: LayoutBuilder(
          builder: (context, constraints) {
            return Stack(
              ...
              children: [FromBottomEndPositionAsOneCharacterConversationWidget(fromBottomEndPositionAsOneCharacterConversationFunctionalFeature: this)],
            );
          },
        ),
