...
class Sample01ContentWidget extends StatefulWidget {
  const Sample01ContentWidget({super.key, required this.systemStateManagement, required this.sizeDx, required this.sizeDy});
  ...
  @override
  State<Sample01ContentWidget> createState() => _Sample01ContentWidgetState();
}

class _Sample01ContentWidgetState extends State<Sample01ContentWidget> {
  @override
  void initState() {
    super.initState();
  }
